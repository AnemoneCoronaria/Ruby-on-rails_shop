...
ActiveRecord::Schema[8.1].define(version: 2026_04_01_061514) do
  ...
  create_table "product_keywords", force: :cascade do |t|
    ...
    t.integer "product_id", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id", "keyword_id"], name: "index_product_keywords_on_product_id_and_keyword_id", unique: true
  end
